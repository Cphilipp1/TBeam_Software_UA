...
def parallel_error_calculation(x_grid, y_grid, receivers, num_nanos, transmitter):
...
def main():
    ...
    if single:         
        ...
        error_grid = parallel_error_calculation(x_grid, y_grid, receivers, num_nanos, transmitter)
